...
namespace AnalizaObrazu
{
    ...
    static class Efekty
    {
        ...
        public static Bitmap Kanal(Bitmap bitmapaWe, string s)
        {
            int wysokosc = bitmapaWe.Height;
            int szerokosc = bitmapaWe.Width;
            ...
            unsafe
            {
                for (int y = 0; y < wysokosc; y++)
                {
                    ...
                    for (int x = 0; x < szerokosc; x++)
                    {
                        ...
                        Rgb pixelWynikowy = ((Rgb*)pWe)[x]; ;
                        switch(s)
                        {
                            case "r": pixelWynikowy.g = 0; pixelWynikowy.b = 0; break;
                            case "g": pixelWynikowy.r = 0; pixelWynikowy.b = 0; break;
                            case "b": pixelWynikowy.r = 0; pixelWynikowy.g = 0; break;
                        }
